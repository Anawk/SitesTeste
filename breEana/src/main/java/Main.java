...
public class Main {
    ...
    public static void gerenciarAluno(){
        Aluno a1 = new Aluno("1", Nota, "Jose", "sp3075246", "");
        Aluno a2 = new Aluno("2", "7,8,10");
        Aluno a3 = new Aluno("3", "5,7,2");
        Aluno a4 = new Aluno("4", "Rio de janeiro");
        Aluno a5 = new Aluno("5", "São Paulo");
        Aluno a6 = new Aluno("6", "Belo Horizonte");
